...
const VerticalNavMenuGroup:React.FC<any> = ({
  item,
  groupOpen,
  menuHover,
  activeItem,
  ...
  // ** Toggle Open Group
  const toggleOpenGroup = (item: { id: any; children: any; }, parent: { children: any; }) => {
  ...
  // ** On Group Item Click
  const onCollapseClick = (e: React.MouseEvent<HTMLAnchorElement, MouseEvent>, item: { id: any; children: any; }) => {
