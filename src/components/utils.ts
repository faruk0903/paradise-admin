...
const checkForVisibleChild = (arr: any, ability: any = { can: () => true }) => {
  console.log(ability, "ability");
  return arr.some((i: any) => {
    console.log("Current item:", i);
    if (i.children) {
      console.log("Checking children for visibility:", i.children);
      return checkForVisibleChild(i.children, ability);
    } else {
      console.log(
        "Checking ability for action:",
        i.action,
        "and resource:",
        i.resource
      );
...
// const checkForVisibleChild = (arr, ability = { can: () => false }) => {
//   return arr.some((i) => {
//     if (i.children) {
//       return checkForVisibleChild(i.children, ability);
//     } else {
